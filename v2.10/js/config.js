...
Yuki.ST.DEFAULT_FORMAT_TEMPLATE = [
  ...
  '<summary>对本次正文的一段小总结</summary>',
  '<meta>对小总结的一句话再提炼（大总结，用于长期记忆检索）</meta>',
  '<option>选项A',
  '选项B</option>',
  '<sum>简短总结</sum>',
  '<vars>{"变量名":新值}</vars>',
...
Yuki.ST.DEFAULT_WARDROBE = {
  yukina: {
    衣装:'纯白冬大衣', 下装:'藏蓝百褶裙', 脚部:'象牙白系带短靴',
    手部:'手织连指手套', 头部:'红色贝雷帽', 发型:'及腰长直发',
    首饰:'雪花结晶项链', 戒指:'—'
  },
  kanade: {
    衣装:'黑色皮夹克', 下装:'破洞紧身牛仔裤', 脚部:'高帮帆布鞋',
    手部:'火焰刺绣护腕', 头部:'—', 发型:'栗色波波头',
    首饰:'十字架耳钉', 戒指:'火焰纹拇指戒'
  },
  rei: {
    衣装:'天文观测风衣', 下装:'深灰西装长裤', 脚部:'静音软底鞋',
    手部:'翻盖观测手套', 头部:'—', 发型:'深蓝长直发',
    首饰:'星辰陨石胸针', 戒指:'—'
  }
};
...
Yuki.ST.SUPPORTED_MACROS = [
  ...
  { name: '{{memory}}',      desc: '分层记忆上下文（全文→摘要→元摘要）' },
];
