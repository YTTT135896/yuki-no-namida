...
Yuki.Features.wardrobe = {
  ...
  /** Render a single slot card for the grid */
  _renderSlotCard: function(slot, name, icon, set, isEmpty, charName, slotKey) {
    ...
    return '<div class="' + cls + '"' + click + '>' +
      ...
      '<span class="material-symbols-rounded wb-slot-icon">' + icon + '</span>' +
  ...
  _showDetailPopup: function(item) {
    document.getElementById('wb-detail-icon').innerHTML = '<span class="material-symbols-rounded" style="font-size:2.4rem">' + item.icon + '</span>';
