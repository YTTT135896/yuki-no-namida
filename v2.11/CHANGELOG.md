...
## v2.11 — 仓库清理 + 衣柜细节修复 (2026-08-12)

### 清理
- 删除 v2.6 之前的所有版本目录（v2.2/v2.3/v2.4/v2.5）和根目录旧版 HTML 文件

### 修复
- **衣柜详情弹窗层级**：z-index 从 180 提升至 400，确保显示在角色详情页之上
- **去除图标**：衣柜卡片和详情弹窗中移除所有 Material Symbols 图标，界面更简洁

### 修改文件
| 文件 | 变更 |
|------|------|
| `css/modals.css` | z-index 180→400，删除 `.wb-slot-icon` 和 `.wb-detail-icon` 样式 |
| `js/features.js` | 卡片渲染去除图标，弹窗填充去除图标行 |
| `index.html` | 详情弹窗 HTML 去除图标容器 |
