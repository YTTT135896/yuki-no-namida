...
Yuki.ST.memConfig = {
  fullTextLimit: 3,   // how many most-recent full-text entries AI can read
  summaryLimit: 5,    // how many summary entries AI can read (older tier)
  metaLimit: 10       // how many meta-summary entries AI can read (oldest tier)
};
...
Yuki.ST.init = function() {
  return Yuki.ST.openDB().then(function() {
    ...
    Yuki.ST.initChat();
    console.log('%cSillyTavern Core v2.8 %cloaded','color:#c4a15a;font-weight:bold;','color:#928ca0;');
